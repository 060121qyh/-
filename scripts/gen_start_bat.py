# -*- coding: utf-8 -*-
"""生成 scripts/启动看板.bat（GBK 编码，REQ-20260813-004 任务1）"""
BAT = r"""@echo off
rem ============================================================
...
out = r"D:\乔一禾\项目工作区\多Agent学习导师\scripts\启动看板.bat"
...
with open(out, "r", encoding="gbk") as f:
    back = f.read()
print("写入 GBK 编码:", out)
print("往返校验:", "通过" if back == BAT else "失败")
print("字节数:", len(BAT.encode("gbk")))
